...
data PromptListChangedNotification
    = PromptListChangedNotification {method :: Text,
                                     params :: (Maybe Params)}
    deriving Arbitrary via (GenericArbitrary PromptListChangedNotification)
    deriving Show
    deriving Eq
    deriving Ord
    deriving Generic
instance ToJSON PromptListChangedNotification
    where {toJSON = Data.Aeson.Types.ToJSON.genericToJSON Data.Aeson.Types.Internal.defaultOptions{Data.Aeson.Types.Internal.fieldLabelModifier = Utils.toJSONField}}
instance FromJSON PromptListChangedNotification
    where {parseJSON = Data.Aeson.Types.FromJSON.genericParseJSON Data.Aeson.Types.Internal.defaultOptions{Data.Aeson.Types.Internal.fieldLabelModifier = Utils.toJSONField}}
